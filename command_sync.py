    ...
    if ENABLE_WHITE_LABEL:
        extra = {
            "en": [
                ...
                BotCommand("wl_start_bot", "▶️ Start connected bot runtime"),
                BotCommand("wl_stop_bot", "🛑 Stop connected bot runtime"),
                BotCommand("wl_runtime_status", "📡 Connected bot runtime status"),
            ...
            "ru": [
                ...
                BotCommand("wl_start_bot", "▶️ Запустить runtime бота"),
                BotCommand("wl_stop_bot", "🛑 Остановить runtime бота"),
                BotCommand("wl_runtime_status", "📡 Статус runtime бота"),
            ...
            "uz": [
                ...
                BotCommand("wl_start_bot", "▶️ Ulangan bot runtime ishga tushirish"),
                BotCommand("wl_stop_bot", "🛑 Ulangan bot runtime to‘xtatish"),
                BotCommand("wl_runtime_status", "📡 Ulangan bot runtime holati"),
